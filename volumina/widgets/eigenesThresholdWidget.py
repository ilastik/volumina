...
class EigenesThresholdWidget(QWidget):
    ...
    def _onCheckboxClicked(self):
        if (self.checkBox.isChecked()):
            print "checked"
            self._minSlider.setEnabled(True)
            self._maxSlider.setEnabled(True)
            self._minSpin.setEnabled(True)
            self._maxSpin.setEnabled(True)
        else:
            print "not checked"
            self._minSlider.setEnabled(False)
            self._maxSlider.setEnabled(False)
            self._minSpin.setEnabled(False)
            self._maxSpin.setEnabled(False)
